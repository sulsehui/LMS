...
<link rel="stylesheet"
	href="resources/css/joinTeacher.css">
...
<div class="joinbox">
  ...
  <div>
   ...
   <option value="@google.com">google.com</option>
    ...
    <input id="textbox" class="fbox" type="file" name="mbFile"/>
  ...
  <a href="/loginForm" id="lbox" ><img
	...
	<div>
   <a href="/joinStuForm" id="lbox" ><img
						src="resources/images/s_profile1.png"
						style="height: 55px; width: 55px;" /> 학생 회원가입</a> 
  </div> 					
 </div>
</body>
</html>